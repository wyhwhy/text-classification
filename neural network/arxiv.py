...
model.add(Bidirectional(LSTM(256,return_sequences=True,activation='tanh')))#Bidirectional
model.add(Dropout(0.4))
#LSTM.output=tf.expand_dims(LSTM.output,-1)
#model.add(ZeroPadding1D(padding=2))
#print(LSTM.output_shape)
model.add(Convolution1D(nb_filter=512,filter_length=3,border_mode='valid',activation='sigmoid',subsample_length=1))
